                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('books.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="judul" type="text" class="form-control" id="name" value="" placeholder="Tuliskan judul" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="name" class="col-sm-2 col-form-label">Tahun</label>
                                <div class="col-sm-10">
                                    <input name="tahun" type="text" class="form-control" id="name" value="" placeholder="Masukan tahun terbit" />
                                </div>
                            </div>
                            <div class="form-group row">
